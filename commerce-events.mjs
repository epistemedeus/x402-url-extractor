...
const EXACT_ROUTES = new Map([
  ...
  ["/SKILL.md", { route: "/skill.md", kind: "discovery" }],
  ["/.well-known/skills", { route: "/.well-known/skills/index.json", kind: "discovery" }],
  ["/.well-known/skills/", { route: "/.well-known/skills/index.json", kind: "discovery" }],
  ["/.well-known/skills/index.json", { route: "/.well-known/skills/index.json", kind: "discovery" }],
  ["/.well-known/skills/web-extract", { route: "/.well-known/skills/web-extract/SKILL.md", kind: "discovery" }],
  ["/.well-known/skills/web-extract/SKILL.md", { route: "/.well-known/skills/web-extract/SKILL.md", kind: "discovery" }],
  ["/.well-known/skills/page-change", { route: "/.well-known/skills/page-change/SKILL.md", kind: "discovery" }],
  ["/.well-known/skills/page-change/SKILL.md", { route: "/.well-known/skills/page-change/SKILL.md", kind: "discovery" }],
  ["/.well-known/skills/explicit-record", { route: "/.well-known/skills/explicit-record/SKILL.md", kind: "discovery" }],
  ["/.well-known/skills/explicit-record/SKILL.md", { route: "/.well-known/skills/explicit-record/SKILL.md", kind: "discovery" }],
