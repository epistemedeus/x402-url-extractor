...
test("application errors and malformed success stay untyped", async () => {
  ...
  try {
    ...
    const { accepts: badAccepts } = await unpaidAccepts(mounted, "https://malformed.example/");
    const malformed = await paidExtract(mounted, badAccepts, "https://malformed.example/", 22);
