...
export const BAZAAR_RESOURCE_METADATA = Object.freeze({
  ...
  "/commerce/seller-integrity-audit": Object.freeze({
    serviceName: "SameDayDesk",
    tags: Object.freeze(["x402", "mpp", "seller-ci", "response-contract", "machine-buyability"]),
  }),
  "/x402/monitor": Object.freeze({
    serviceName: "SameDayDesk",
    tags: Object.freeze(["x402", "monitor", "seller-ci", "machine-buyability", "route-audit"]),
  }),
  "/commerce/contract-qualified-search": Object.freeze({
    serviceName: "SameDayDesk",
    tags: Object.freeze(["agent-search", "x402", "mpp", "response-contract", "buyer-safety"]),
  }),
  "/distribution/agent-surface-budget-audit": Object.freeze({
    serviceName: "SameDayDesk",
    tags: Object.freeze(["mcp", "openapi", "context-budget", "tool-discovery", "agent-finops"]),
  }),
  "/commerce/settlement-proof": Object.freeze({
    serviceName: "SameDayDesk",
  ...
  "/chain/solana-transaction-receipt": Object.freeze({
    serviceName: "SameDayDesk",
    tags: Object.freeze(["transaction-receipt", "solana", "spl-token", "usdc", "settlement"]),
  }),
  "/security/wallet-policy-conformance": Object.freeze({
    serviceName: "SameDayDesk",
