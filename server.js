...
const RESOURCES = [
  ...
  { url: `${PUBLIC_URL}/commerce/seller-integrity-audit`, amount: priceToAtomic(SELLER_INTEGRITY_AUDIT_PRICE), description: "Audit one exact paid GET or POST route before buyers spend. Checks constructible non-secret input, live unpaid GET terms, optional Bazaar metadata, and buyer-required success paths. Returns machine_buyable, contract_ready, or repair_required. Uses no credential or target payment, follows no redirect, and sends no target POST.", mimeType: "application/json" },
