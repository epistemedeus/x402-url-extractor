          ...
          ...declareDiscoveryContract({
            ...
            inputSchema: {
              ...
              properties: {
                ...
                expectedPriceUsd: { type: "number", minimum: 0, maximum: 1000000, multipleOf: 0.000001, description: "Optional exact route price expected by the caller. Requires route and is compared only with catalog metadata." },
              },
            ...
            output: {
              example: {
                ...
                input: { origin: "https://agents.samedaydesk.com", intent: "extract a public web page into structured JSON metadata headings links and JSON-LD", route: "/extract", expectedPriceUsd: 0.005, expectedPriceAtomic: "5000" },
                summary: { sourceCount: 10, availableSourceCount: 10, targetFoundSourceCount: 4, expectedRouteFoundSourceCount: 4, sourceFamilyCount: 9, targetFoundSourceFamilyCount: 4, matchedPriceSourceCount: 3, driftedPriceSourceCount: 1 },
                sources: { "coinbase-bazaar": { status: "ok", targetFound: true, bestTargetRank: 9, priceObservation: { status: "matched", expectedPriceAtomic: "5000", observedPricesAtomic: ["5000"] } } },
...
app.get("/", (req, res) => {
  const gateway = {
    ...
    paidRoutes: {
      ...
      "GET /distribution/agent-discoverability-audit?origin=&intent=&route=&payTo=&surfaceAudit=": `${AGENT_DISCOVERABILITY_AUDIT_PRICE} - brand-blind agent discovery rank, dependency-labeled coverage, expected-route presence, optional seller-owned surface coverage, and competing results across ten machine-service views.`,
