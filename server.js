...
${line("/distribution/agent-surface-budget-audit", AGENT_SURFACE_BUDGET_AUDIT_PRICE, "public service origin -> bounded MCP tools/list and OpenAPI byte budgets, comparative token estimates, heaviest definitions, missing selection contracts, and progressive-discovery fixes. Calls no target tool and sends no credential or target payment.")}
      ...
      "GET /distribution/agent-surface-budget-audit": {
        ...
        extensions: {
          ...
          ...declareDiscoveryContract({
            ...
            input: { origin: "https://agents.samedaydesk.com", mcpPath: "/mcp", openApiPath: "/openapi.json", mcpBudgetBytes: 65536, openApiBudgetBytes: 524288 },
            inputSchema: {
              type: "object",
              additionalProperties: false,
              properties: {
...
app.get("/", (req, res) => {
  const gateway = {
    ...
    paidRoutes: {
      ...
      "GET /distribution/agent-surface-budget-audit?origin=&mcpPath=&openApiPath=&mcpBudgetBytes=&openApiBudgetBytes=": `${AGENT_SURFACE_BUDGET_AUDIT_PRICE} - measure MCP and OpenAPI agent-context burden, rank the heaviest definitions, and return progressive-discovery fixes without calling a target tool.`,
