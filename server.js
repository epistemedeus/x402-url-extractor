          ...
          ...declareDiscoveryContract({
            ...
            output: {
              example: {
                ...
                sources: { "coinbase-bazaar": { status: "ok", targetFound: true, bestTargetRank: 9, priceObservation: { status: "matched", expectedPriceAtomic: "5000", observedPricesAtomic: ["5000"] }, identityObservation: { status: "canonical", exactRouteRecordCount: 1, canonicalRecordCount: 1, aliasOrigins: [] } } },
