...
const RESOURCES = [
  ...
  { url: `${PUBLIC_URL}/distribution/agent-discoverability-audit`, amount: priceToAtomic(AGENT_DISCOVERABILITY_AUDIT_PRICE), description: "Audit one x402 or MPP service across ten public machine-discovery views. Returns intent rank, canonical and alias records, duplicates, competitors, expected-route presence, exact-price drift, evidence-based next actions, and source outages. Optional checks compare a same-origin unsigned offer and public Agent Card, ERC-8004 document, and action catalog. Uses no catalog credential, signature, or payment.", mimeType: "application/json" },
