...
export function usage() {
  return `samedaydesk-crewai-unpaid-list

Unpaid CrewAI MCP tools/list against SameDayDesk. Initialize plus tools/list
only. Does not call tools, kick off a crew, sign, or pay.
