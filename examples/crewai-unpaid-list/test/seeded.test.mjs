...
import { EXAMPLE_ROOT, parseJsonStdout, runCli } from "./helpers.mjs";
...
test("stdlib Python seeded failure exits 1", async () => {
  const ran = await new Promise((resolve, reject) => {
    const child = spawn("python3", ["python/list_tools.py", "--seeded-failure", "--json"], {
      cwd: EXAMPLE_ROOT,
