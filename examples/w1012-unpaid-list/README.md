# SameDayDesk W1012 unpaid `tools/list`
...
Work item **w1012**. Write boundary is this directory only.
...
cd x402-url-extractor/examples/w1012-unpaid-list
node bin/cli.mjs --json
```

From an existing checkout, start with `cd examples/w1012-unpaid-list`.
