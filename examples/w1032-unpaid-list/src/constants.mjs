...
export const CLIENT_NAME = "samedaydesk-w1032-unpaid-list";
export const CLIENT_VERSION = "0.1.0";
export const USER_AGENT = "SameDayDesk-w1032-unpaid-list/0.1.0";
...
export const REPORT_SCHEMA = "samedaydesk.w1032-unpaid-list.report.v1";
export const SEED_SCHEMA = "samedaydesk.w1032-unpaid-list.seed.v1";
export const MCP_CONFIG_SCHEMA = "samedaydesk.w1032-unpaid-list.config.v1";
export const TIMEOUT_MS = 15_000;
export const MAX_BYTES = 1_000_000;
export const DESIGNATED_SEED_ID = "seeded.false-accept.missing-extract";
export const EXAMPLE_ID = "w1032-unpaid-list";
export const WORK_ITEM = "w1032";
