/**
 * S153 c48 kit-membership helpers for freshness-receipt S8.
...
export const SYNTHETIC_FRESHNESS = join(PACK_ROOT, "fixtures", "synthetic", "freshness");
export const REAL_FRESHNESS = join(PACK_ROOT, "fixtures", "real", "freshness");
export const CLOCK = "2026-09-10T09:54:59Z";
...
export function classifyRel(rel) {
  ...
  if (
    n.includes("fixtures/synthetic/freshness/cases/") ||
    n.includes("fixtures/synthetic/freshness/sources/") ||
    n.includes("fixtures/real/freshness/") ||
    n.startsWith("docs/") ||
    n.startsWith("cases/") ||
