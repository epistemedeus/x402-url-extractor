/**
 * S153 c08 kit-membership helpers for migration-checklist S8.
...
export const SYNTHETIC_MIGRATION = join(PACK_ROOT, "fixtures", "synthetic", "migration");
...
export function classifyRel(rel) {
  ...
  if (
    n.includes("fixtures/synthetic/migration/docs/") ||
    n.includes("fixtures/synthetic/migration/cases/") ||
    n.startsWith("docs/") ||
    n.startsWith("cases/") ||
