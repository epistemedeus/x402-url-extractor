/**
 * w1030: unpaid x402 amount matrix across SDS HTTP 402, MCP tools/list,
...
export const WAVE = "w1030";
export const SCHEMA_FIXTURE = "samedaydesk.x402-protocol-fixtures.w1030-amount-matrix.v1";
export const SCHEMA_REPORT = "samedaydesk.x402-protocol-report.w1030-amount-matrix.v1";
