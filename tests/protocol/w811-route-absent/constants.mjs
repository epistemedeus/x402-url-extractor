/**
 * w811: an x402 route that is not declared must stay route_absent.
 * It is not HTTP 402, not PAYMENT-REQUIRED, and not settlement.
 * Unpaid loopback only. Never send a live payment.
 */
export const SCHEMA_FIXTURE = "samedaydesk.x402-protocol-fixtures.w811-route-absent.v1";
export const SCHEMA_REPORT = "samedaydesk.x402-protocol-report.w811-route-absent.v1";
...
export const ABSENT_ROUTE = "/w811-absent-route";
