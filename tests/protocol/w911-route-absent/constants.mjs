/**
 * w911: x402 `route_absent` is a checked observation, not demand.
 ...
 */
export const SCHEMA_FIXTURE = "samedaydesk.x402-protocol-fixtures.w911-route-absent.v1";
export const SCHEMA_REPORT = "samedaydesk.x402-protocol-report.w911-route-absent.v1";
