/**
 * w1109: x402 MCP unpaid tools/call is HTTP 200 JSON-RPC result.isError=true.
 ...
 */
export const SCHEMA_FIXTURE = "samedaydesk.x402-protocol-fixtures.w1109-mcp-iserror.v1";
export const SCHEMA_REPORT = "samedaydesk.x402-protocol-report.w1109-mcp-iserror.v1";
