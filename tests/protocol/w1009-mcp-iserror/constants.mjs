/**
 * w1009: x402 MCP unpaid tools/call is HTTP 200 JSON-RPC result.isError=true.
 ...
 */
export const SCHEMA_FIXTURE = "samedaydesk.x402-protocol-fixtures.w1009-mcp-iserror.v1";
export const SCHEMA_REPORT = "samedaydesk.x402-protocol-report.w1009-mcp-iserror.v1";
