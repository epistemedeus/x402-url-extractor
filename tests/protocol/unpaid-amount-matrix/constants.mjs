/**
 * SDS unpaid 402 amount matrix pins (W1-R11 / R11-402-01).
 * Atomic amounts are strings. Display OpenAPI tokens are pinned literals,
 * never derived by dividing atomic units.
 */

export const SCHEMA_FIXTURE = "samedaydesk.unpaid-amount-matrix-fixture.v1";
export const SCHEMA_REPORT = "samedaydesk.unpaid-amount-matrix-report.v1";
